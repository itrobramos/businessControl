                                    ...
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-primary font-weight-bold text-xs mb-1">
                                                <span>Abonos</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span>$2,500</span></div>
                                        </div>
                                    ...
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-success font-weight-bold text-xs mb-1">
                                                <span>Pendiente de Cobranza</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span>$1,200</span></div>
                                        </div>
                                    ...
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-info font-weight-bold text-xs mb-1">
                                                <span>Pendiente de Pago</span></div>
                                    ...
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-warning font-weight-bold text-xs mb-1">
                                                <span>Balance</div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span>$2,900</span></div>
                                        </div>
